...
print(SubjectiveDataResult.model_validate(sub_json_obj))
print("[bold blue]objective data: [/bold blue]")
print(ObjectiveDataResult.model_validate(obj_json_obj))
...
print(AssessmentResult.model_validate(assessment_json_obj))
