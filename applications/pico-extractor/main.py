...
def main(pdf_path: str = typer.Argument(..., help="Path to the clinical research PDF file.")):
    """
    Extracts Population, Intervention, Comparison, and Outcome (PICO)
    from a clinical research PDF.
    """
    with Progress(
        SpinnerColumn(),
        ...
        try:
            ...
            if not text:
                print("[bold red]Error: Could not extract text from the PDF. It may be empty or image-based.[/bold red]")
                raise typer.Exit(1)
